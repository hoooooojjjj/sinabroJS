...
const user = UserFactory.createUser("regular", {
  name: "사용자",
  email: "user@test.com",
});
...
console.log(
  "Strategy 패턴:",
  paymentProcessor.processPayment(50000, { cardNumber: "**** **** **** 1234" })
);
...
console.log(
  "Strategy 패턴:",
  paymentProcessor.processPayment(30000, { email: "user@paypal.com" })
);
